        ...
        for _ in range(episodes):
            ...
            while not terminal:
                ...
                if terminal:
                    ...
                    nd_idx, np_idx = self._get_indices(next_state) # On-policy : Action is chose BEFORE updating
                    ...
                    delta = reward + self.Q[nd_idx, np_idx, na_idx] - self.Q[d_idx, p_idx, a_idx] 
...
class LinearAgent(Easy21Agent):
    ...
    def sarsa_learn_linear(self, lmbda, episodes=1000):
        """
        Implement SARSA(lambda) algorithm with epsilon-greedy exploration
        """
